...
**1. [Mediterranean of Egypt (MOE)](https://github.com/Kyarakuta07/School-Management-System)**
A virtual role-play school management system built with Native PHP.
* **Focus:** Scalable architecture, role-based access, and immersive user experience.

**2. [Architecture Portfolio](https://github.com/Kyarakuta07/architecture-portfolio)**
A minimalist company profile and portfolio website designed for a professional architect.
* **Focus:** Visual storytelling, responsive gallery, and clean UI/UX.
